...
[`@aws-sdk/client-invoicing`](https://www.npmjs.com/package/@aws-sdk/client-invoicing/v/3.1131.0).
...
- @aws-sdk/client-invoicing v3.1131.0 - [https://cloud-sdk-builds.github.io/?sdk=client-invoicing&version=3.1131.0](https://cloud-sdk-builds.github.io/?sdk=client-invoicing&version=3.1131.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-invoicing@3.1131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jvp5e6MJBlniyuAccyTr01cOOcNFXUj/JYElP+GtLZIoOuWic8a2n3K+Eq+lEWGu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-invoicing": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-invoicing@3.1131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-invoicing@3.1131.0/index.min.mjs": "sha384-jvp5e6MJBlniyuAccyTr01cOOcNFXUj/JYElP+GtLZIoOuWic8a2n3K+Eq+lEWGu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-invoicing/blob/refs/tags/3.1131.0/LICENSE
```
